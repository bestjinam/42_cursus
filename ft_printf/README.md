...
- 비트 연산자로 플래그 처리하기
	- 간단한 정리 
		...
		- or 연산 (|) : 대응하는 두개 비트 중 모두 1이거나 하나라도 1일 경우 1을 반환
		- 시프트 (>> <<) : 왼쪽 또는 오른쪽 으로 비트를 옮겨서 반환 
	- 예 
		- 1 << 0 : 0000 0001 => 1000 0000 | 0000 0001 = 1000 0001
		- 1 << 1 : 0000 0010 => 1000 0000 | 0000 0010 = 1000 0010
		- 1 << 2 : 0000 0100 => 1000 0000 | 0000 0100 = 1000 0100
		- 1 << 3 : 0000 1000 => 1000 0000 | 0000 1000 = 1000 1000
		- 1 << 4 : 0001 0000 => 1000 0000 | 0001 0000 = 1001 0000

### void	_bit_mod_flags(t_format *format)
- 플래그들간의 관계 
	- . (precision) 이나 -는 0 보다 우선 함(0 무시됨)
	- + 는 ' ' 보다 우선함 
- 비트 처리 
	- and 연산 사용하여 해당 플래그가 있는지 확인한다. 
	- and 연산은 두 비트 둘다 1인 경우에만 1 
	- 따라서 원하는 값이 있으면 무조건 1 아니면 무조건 0임 
